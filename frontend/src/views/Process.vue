<template>
  <div class="process-page">
    <!-- 顶部导航栏 -->
    <nav class="navbar">
      <div class="nav-brand" @click="goHome">Mapear AI</div>
    ...
    <div class="main-content">
      ...
      <div class="left-panel" :class="{ 'full-screen': isFullScreen }">
          ...
          <div class="header-right">
            ...
            <div class="action-buttons">
              <button
                ...
                title="刷新图谱"
              >
                <span class="icon-refresh" :class="{ spinning: graphLoading }"
                  >↻</span
                >
              </button>
              <button
        ...
        <div class="graph-container" ref="graphContainer">
          ...
          <div v-if="graphData" class="graph-view">
            ...
            <div v-if="selectedItem" class="detail-panel">
              ...
              <div v-else class="detail-content">
                ...
                <div
                  class="detail-section"
                  v-if="selectedItem.data.episodes?.length"
                >
          ...
          <!-- 构建中但还没有数据 -->
          <div
            v-else-if="currentPhase === 1 && !graphData"
            class="graph-waiting"
          >
            <div class="loading-animation">
              <div class="loading-ring"></div>
        ...
        <div class="process-content">
            ...
            <div class="phase-detail">
              <div class="detail-section">
                ...
                <div class="detail-content">
                  上传文档后，LLM分析文档内容，自动生成适合舆论模拟的本体结构（实体类型
                  + 关系类型）
                </div>
              </div>
              ...
              <div
                class="detail-section"
                v-if="ontologyProgress && currentPhase === 0"
              >
              ...
              <div class="detail-section" v-if="projectData?.ontology">
                <div class="detail-label">
                  生成的实体类型 ({{
                    projectData.ontology.entity_types?.length || 0
                  }})
                </div>
              ...
              <div class="detail-section" v-if="projectData?.ontology">
                <div class="detail-label">
                  生成的关系类型 ({{
                    projectData.ontology.relation_types?.length || 0
                  }})
                </div>
                <div class="relation-list">
                  <div
                    v-for="(
                      rel, idx
                    ) in projectData.ontology.relation_types?.slice(0, 5) || []"
                    :key="idx"
                    class="relation-item"
                  >
                  ...
                  <div
                    v-if="
                      (projectData.ontology.relation_types?.length || 0) > 5
                    "
                    class="relation-more"
                  >
                    +{{
              ...
              <!-- 等待状态 -->
              <div
                class="detail-section waiting-state"
                v-if="
          ...
          >
            ...
            <div class="phase-detail">
              ...
              <div
                class="detail-section"
                v-if="buildProgress && currentPhase >= 1"
              >
          ...
          <div class="project-details" v-if="projectData">
            ...
            <div class="project-item">
              ...
              <span class="item-value">{{
                projectData.simulation_requirement || "-"
              }}</span>
            </div>
          </div>
        </div>
...
const selectNode = (nodeData, color) => {
  selectedItem.value = {
    ...
    color: color,
    entityType:
      nodeData.labels?.find((l) => l !== "Entity" && l !== "Node") || "Entity",
  };
};
    ...
    if (projectResponse.success && projectResponse.data.graph_id) {
      ...
      if (graphResponse.success && graphResponse.data) {
        ...
        console.log(
          ...
          newNodeCount,
          "edges:",
          newData.edge_count || newData.edges?.length || 0,
        );
...
const renderGraph = () => {
  ...
  const linkLabel = g
    ...
    .attr("text-anchor", "middle")
    .text((d) =>
      d.type.length > 15 ? d.type.substring(0, 12) + "..." : d.type,
    );
